...
"""
Add default config for GPTrack.
"""
cfg = edict()
...
# RGBT.BACKBONE
cfg.MODEL.BACKBONE.GPTRACK_LOC = []
...
# GPTrack
cfg.TRAIN.GPTRACK_DROP_RATE = 0.  # dropout rate for TransformerDecoderLayer
cfg.TRAIN.GPTRACK_DROP_PATH = []  # drop_path rate for GPTrack Attention_st
...
cfg.VIS_MASK = False
cfg.VIS_MASK_DIR = "/home/dell/data/qixi/RGBT_tracking/GPTrack/vis_masks"
