...
from lib.models.gptrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def finetune_track(self, cfg, patch_start_index=1):
        ...
        self.pos_embed_x_last = nn.Parameter(search_patch_pos_embed)
    ...
    def forward_features(self, z, x):
        ...
        aux_dict = {"attn": None}
        extra = {}
        return self.norm(x), aux_dict, extra

    def forward(self, z, x, **kwargs):
        """
        Joint feature extraction and multi-relational edge construction for the basic ViT backbone.
        Args:
        ...
        # x, aux_dict, extra = self.forward_features(z, x,)

        return x, aux_dict
        # return x, aux_dict, extra
